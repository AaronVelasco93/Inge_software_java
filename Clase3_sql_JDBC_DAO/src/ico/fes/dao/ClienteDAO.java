...
public class ClienteDAO implements InterfazDAO {
    ...
    public ArrayList obetenerTodo() throws SQLException {
        ...
        while (rst.next()) {
            resultado.add(new Cliente(rst.getString("CODIGOCLIENTE"), rst.getString("EMPRESA"),
                    rst.getString("DIRECCION"), rst.getString("POBLACION"), rst.getInt("TELEFONO"),
                    rst.getString("RESPONSABLE"), rst.getString("HISTORIAL")));
        }
